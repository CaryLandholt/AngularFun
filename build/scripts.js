...
define("libs/modernizr", (function (global) {
    return function () {
...
define("libs/angular", ["libs/modernizr"], (function (global) {
    return function () {
...
define('controllers/controllers',['libs/angular'], function(angular) {
...
define('directives/directives',['libs/angular'], function(angular) {
...
define('filters/filters',['libs/angular'], function(angular) {
  
  return angular.module('filters', []);
});

/**
 * @license AngularJS v1.0.2-212f685e
 * (c) 2010-2012 Google, Inc. http://angularjs.org
 * License: MIT
 */
...
define("libs/angular-resource", function(){});

// Generated by CoffeeScript 1.3.3
/*global define
*/

define('responseInterceptors/responseInterceptors',['libs/angular'], function(angular) {
  
  return angular.module('responseInterceptors', []);
});
...
define('services/services',['libs/angular'], function(angular) {
...
define('app',['libs/angular', 'controllers/controllers', 'directives/directives', 'filters/filters', 'libs/angularResource', 'responseInterceptors/responseInterceptors', 'services/services'], function(angular) {
...
define('bootstrap',['require', 'libs/angular', 'app'], function(require, angular) {
...
define('services/message',['services/services'], function(services) {
...
define('services/gitHub',['libs/angular', 'services/services', 'services/message', 'libs/angularResource'], function(angular, services) {
...
define('controllers/gitHub',['controllers/controllers', 'services/gitHub'], function(controllers) {
...
define('services/people',['libs/angular', 'services/services', 'libs/angularResource'], function(angular, services) {
...
define('controllers/people',['controllers/controllers', 'services/people'], function(controllers) {
...
define('controllers/personDetails',['controllers/controllers', 'services/people'], function(controllers) {
  ...
  return controllers.controller('personDetails', [
    '$scope', '$rootScope', 'people', function($scope, $rootScope, service) {
      ...
      return $scope.onRouteChange = function(routeParams) {
        return service.getPerson(routeParams.id);
      };
    }
  ]);
});
...
define('controllers/searchHistory',['controllers/controllers', 'services/message'], function(controllers) {
...
define('services/twitter',['libs/angular', 'services/services', 'services/message', 'libs/angularResource'], function(angular, services) {
...
define('controllers/twitter',['controllers/controllers', 'services/twitter'], function(controllers) {
...
define('directives/ngController',['directives/directives'], function(directives) {
...
define('libs/text',['module'], function (module) {
...
define('libs/text!partials/tabs.html',[],function () { return '<div class="tabbable">\n\t<ul class="nav nav-tabs">\n\t\t<li ng-repeat="tab in tabs" ng-class="{active:tab.selected}">\n\t\t\t<a href="" ng-click="select(tab)">{{tab.caption}}</a>\n\t\t</li>\n\t</ul>\n\t<div class="tab-content" ng-transclude></div>\n</div>';});

// Generated by CoffeeScript 1.3.3
/*global define
*/

define('directives/tabs',['libs/angular', 'directives/directives', 'libs/text!partials/tabs.html'], function(angular, directives, template) {
...
define('libs/text!partials/tab.html',[],function () { return '<div class="tab-pane" ng-class="{active: selected}" ng-transclude></div>';});

// Generated by CoffeeScript 1.3.3
/*global define
*/

define('directives/tab',['directives/directives', 'libs/text!partials/tab.html', 'directives/tabs'], function(directives, template) {
...
define('filters/twitterfy',['filters/filters'], function(filters) {
...
define('responseInterceptors/dispatcher',['responseInterceptors/responseInterceptors', 'statuses'], function(responseInterceptors, statuses) {
